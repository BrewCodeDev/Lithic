...
EVM output supports its documented stateless subset. Native LithoVM v8 also
supports mutable and immutable locals, staged contract-call intents and native
transfers, typed events, scalar storage, explicit host context, typed
expressions and structured if/else returns.
